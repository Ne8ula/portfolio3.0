      ...
      >
        ...
        <div className="cube-face face-back border border-border/30 bg-card/5 p-2 flex-col items-center justify-center">
          <div className="w-full h-full border border-border/20 grid-pattern flex flex-col items-center justify-between text-muted-foreground relative p-3">
            ...
            {/* Top Corners */}
            <div className="w-full flex justify-between items-start z-10 opacity-80">
              <img src="/assets/micrographics/Micrographics Vol.1 - Editable 15.svg" className="w-6 h-6 mix-blend-multiply" alt="corner detail top left" />
              <img src="/assets/micrographics/Micrographics Vol.1 - Editable 21.svg" className="w-6 h-6 mix-blend-multiply" alt="tech node top right" />
            </div>

            {/* Center Graphic */}
            <div className="flex-1 flex items-center justify-center w-full relative z-10">
              <img src="/assets/micrographics/Micrographics Vol.1 - Editable 12.svg" className="absolute w-28 h-28 opacity-80 mix-blend-multiply" alt="core diagram" />
              <div className="absolute w-1.5 h-1.5 bg-primary/60 rounded-full animate-ping"></div>
            </div>

            {/* Bottom Corners */}
            <div className="w-full flex justify-between items-end z-10 opacity-80">
              <img src="/assets/micrographics/Micrographics Vol.1 - Editable 50.svg" className="w-10 h-4 mix-blend-multiply" alt="data stream bottom left" />
              <img src="/assets/micrographics/Micrographics Vol.1 - Editable 8.svg" className="w-6 h-6 mix-blend-multiply" alt="corner detail bottom right" />
            </div>
          </div>
        </div>
